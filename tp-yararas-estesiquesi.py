...
# Hay 311 departamentos sin operadores, datos en departamentos_sin_operadores
...
provincias1=my_order[:12]
provincias2=my_order[12:]

data_seleccionada1 = grafico4[grafico4['provincia_nombre_2'].isin(provincias1)]
data_seleccionada2 = grafico4[grafico4['provincia_nombre_2'].isin(provincias2)]

sns.violinplot(data = data_seleccionada1, x = "log", y="provincia_nombre_2", order = provincias1)
plt.xlabel('Logaritmo del Ingreso Promedio')
plt.ylabel('Provincia')
plt.show()
plt.close()
sns.violinplot(data = data_seleccionada2, x = "log", y="provincia_nombre_2", order = provincias2)
plt.xlabel('Logaritmo del Ingreso Promedio')
plt.ylabel('Provincia')
plt.show()
plt.close()
...
g.despine(left=True)
g.set_axis_labels("", "Cantidad de operadores")

#Guardado de tablas en 3FN con sus correspondientes nombres
Operadores_Organicos = padron.rename(columns={'departamento_id_3': 'departamento_id'})
#Operadores_Organicos.to_csv()
#rubro.to_csv()
#rubro_clae.to_csv()
#categoria.to_csv()
...
#Salario_del_sector_privado.to_csv()
#clases.to_csv()
#letra.to_csv()
